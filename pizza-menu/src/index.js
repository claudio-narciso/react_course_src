...
function Menu() {
  return (
    <main className="menu">
      ...
      {pizzaData.length > 0 ? (
        <>
        <p>Authentic Italian cuisine. 6 creative dishes to choose fron. All fron our stone oven, all organic, all delicious.</p>
        <ul className="pizzas">
          {pizzaData.map((pizza) => (
...
const Footer = () => {
  ...
  <footer className="footer">
    {isOpen ? (
      ...
      <p>We're closed for the moment, we will open at {closeHour}:00</p>
    )
    }
  </footer>
